...
func main() {
	...
	mux.Handle("GET /admin/vote/new", router.InjectJwtMiddleware(router.EnforceJwtMiddleware(http.HandlerFunc(router.adminVoteEdit))))
	mux.Handle("/admin/vote/{election_id}", router.InjectJwtMiddleware(router.EnforceJwtMiddleware(http.HandlerFunc(router.adminVoteEdit))))
	mux.Handle("/admin/vote/{election_id}/delete", router.InjectJwtMiddleware(router.EnforceJwtMiddleware(http.HandlerFunc(router.adminVoteDelete))))
	mux.Handle("/admin/vote/{election_id}/{candidate_id}", router.InjectJwtMiddleware(router.EnforceJwtMiddleware(http.HandlerFunc(router.adminVoteCandidateEdit))))
	mux.Handle("/admin/vote/{election_id}/publish", router.InjectJwtMiddleware(router.EnforceJwtMiddleware(http.HandlerFunc(router.adminVotePublish))))
	mux.Handle("/admin/vote/{election_id}/close", router.InjectJwtMiddleware(router.EnforceJwtMiddleware(http.HandlerFunc(router.adminVoteClose))))
